...
import filePicker.activity.ImageBrowserActivity;
...
import static filePicker.activity.ImageBrowserActivity.IMAGE_BROWSER_INIT_INDEX;
import static filePicker.activity.ImageBrowserActivity.IMAGE_BROWSER_SELECTED_LIST;
...
public class ImagePickAdapter extends BaseAdapter<ImageFile, filePicker.adapter.ImagePickAdapter.ImagePickViewHolder> {
