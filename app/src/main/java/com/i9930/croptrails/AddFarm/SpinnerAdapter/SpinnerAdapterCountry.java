...
public class SpinnerAdapterCountry extends ArrayAdapter<CountryDatum> implements Filterable, ISpinnerSelectedView {

    private Context mContext;
    private ArrayList<CountryDatum> mBackupStrings;
    private ArrayList<CountryDatum> mStrings;
    private StringFilter mStringFilter = new StringFilter();

    public SpinnerAdapterCountry(Context context, ArrayList<CountryDatum> strings) {
    ...
    public View getNoSelectionView() {
        ...
        try {
            TextView dispalyName = (TextView) view.findViewById(R.id.TxtVw_DisplayName);
            dispalyName.setText(mContext.getResources().getString(R.string.country_prompt));
        }catch (Exception e){}
        return view;
    }
    ...
    public class StringFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<CountryDatum> filterStrings = new ArrayList<>();
            for (CountryDatum text : mBackupStrings) {
