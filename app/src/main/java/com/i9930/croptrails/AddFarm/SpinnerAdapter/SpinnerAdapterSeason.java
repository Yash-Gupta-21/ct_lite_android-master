...
public class SpinnerAdapterSeason extends ArrayAdapter<Season> implements Filterable, ISpinnerSelectedView {

    private Context mContext;
    private List<Season> mBackupStrings;
    private List<Season> mStrings;
    private SpinnerAdapterSeason.StringFilter mStringFilter = new SpinnerAdapterSeason.StringFilter();

    public SpinnerAdapterSeason(Context context, List<Season> strings) {
    ...
    public class StringFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<Season> filterStrings = new ArrayList<>();
            for (Season text : mBackupStrings) {
