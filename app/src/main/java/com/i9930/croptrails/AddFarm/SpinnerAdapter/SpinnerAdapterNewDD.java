...
public class SpinnerAdapterNewDD extends ArrayAdapter<DDNew> implements Filterable, ISpinnerSelectedView {
    ...
    public SpinnerAdapterNewDD(Context context, List<DDNew> strings, String prompt) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            try {
                dispalyName.setText(mStrings.get(position - 1).getParameters());
            } catch (Exception e) {
    ...
    public class StringFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            for (DDNew text : mBackupStrings) {
                ...
                if (AppConstants.isValidString(text.getParameters()) && text.getParameters().toLowerCase().trim().contains(constraint.toString().toLowerCase().trim())) {
