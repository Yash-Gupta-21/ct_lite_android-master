package com.i9930.croptrails.Maps;

import android.os.Bundle;

import androidx.appcompat.app.AppCompatActivity;

public class MapsActivityNew extends AppCompatActivity {

    String TAG = "MapsActivityNew";
   /* private static final String TAG_DIALOG_FRAGMENTS = "dialog";
    ...
    ArrayList<com.esri.core.geometry.Point> mPoints = new ArrayList<com.esri.core.geometry.Point>();

    ArrayList<com.esri.core.geometry.Point> mMidPoints = new ArrayList<com.esri.core.geometry.Point>();
...
*/
    ...
    private void drawPolylineOrPolygon() {
        ...
        if (mPoints.size() > 1) {
            ...
            if (mEditMode == EditMode.POLYLINE) {
                ...
                multipath = new com.esri.core.geometry.Polygon();
            }
            multipath.startPath(mPoints.get(0));
            for (int i = 1; i < mPoints.size(); i++) {
                multipath.lineTo(mPoints.get(i));
    ...
    *//**
    ...
    private class EditingStates {
        ArrayList<com.esri.core.geometry.Point> points = new ArrayList<com.esri.core.geometry.Point>();
        ...
        public EditingStates(ArrayList<com.esri.core.geometry.Point> points, boolean midpointselected, boolean vertexselected, int insertingindex) {
    ...
    private class DragListener extends MapOnTouchListener{
        ...
        public boolean onDragPointerUp(MotionEvent from, final MotionEvent to) {
            ...
            if(type == Geometry.Type.POLYLINE){
                ...
                fl3.updateGraphic(graphic.getUid(), multipath);
            }
