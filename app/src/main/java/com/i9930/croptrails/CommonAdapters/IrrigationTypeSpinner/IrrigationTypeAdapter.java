package com.i9930.croptrails.CommonAdapters.IrrigationTypeSpinner;
...
public class IrrigationTypeAdapter extends ArrayAdapter {
    List<IrrigationType> irrigationList;
    int mResource;
    Context context;

    public IrrigationTypeAdapter(Context context, int resource,List<IrrigationType> irrigationList) {
    ...
    private View createItemView(int position, View convertView, ViewGroup parent){
        ...
        spinner_items_tv.setText(irrigationList.get(position    ).getName());
