package com.i9930.croptrails.CommonAdapters.CropSpinner;
...
public class CropSpinnerAdapter extends ArrayAdapter {

    List<FarmCrop> irrigationSourceList;
    int mResource;
    Context context;
    ...
    public CropSpinnerAdapter(@NonNull Context context, int resource, List<FarmCrop> irrigationSourceList) {
