package com.i9930.croptrails.Language.picker;
...
import com.i9930.croptrails.Language.blur.PickerUIBlurHelper;
...
public class PickerUI extends RelativeLayout implements PickerUIBlurHelper.BlurFinishedListener {
    ...
    public void setItems(Context context, List<String> items) {
        if (items != null) {
            setItems(context, items, items.size() / 2);
        }
    }
     ...
     * @param position the position to set in the center of the panel.
     */
    public void setItems(Context context, List<String> items, int position) {
        if (items != null) {
            this.items = items;
            mPickerUIListView.setItems(context, items, position, itemsClickables);
    ...
    public void setOnClickItemPickerUIListener(final PickerUIItemClickListener listener) {
        ...
        mPickerUIListView.setOnClickItemPickerUIListener(
                new PickerUIListView.PickerUIItemClickListener() {
                    @Override
                    public void onItemClickItemPickerUI( int position,
                            String valueResult) {
                        if (autoDismiss) {
                            slide(position);
                        }
                        ...
                        mPickerUIListener.onItemClickPickerUI( position, valueResult);
                    }
                });
    }
