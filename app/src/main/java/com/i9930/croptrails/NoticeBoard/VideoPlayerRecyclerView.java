...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private List<NoticeDatum> mediaObjects = new ArrayList<>();
                ...
                public void onClick(View v) {
                    ...
                    if (videoPlayer!=null) {
                        if (videoPlayer.isPlayingAd())
                            ...
                            String mediaUrl = mediaObjects.get(targetPosition).getLink();
    ...
    public void setMediaObjects(List<NoticeDatum> mediaObjects){
