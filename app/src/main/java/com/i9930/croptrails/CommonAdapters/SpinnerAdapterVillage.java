...
public class SpinnerAdapterVillage extends ArrayAdapter<ClusterVillages> implements Filterable, ISpinnerSelectedView {

    private Context mContext;
    private ArrayList<ClusterVillages> mBackupStrings;
    private ArrayList<ClusterVillages> mStrings;
    private SpinnerAdapterVillage.StringFilter mStringFilter = new SpinnerAdapterVillage.StringFilter();

    public SpinnerAdapterVillage(Context context, ArrayList<ClusterVillages> strings) {
    ...
    @Override
    public ClusterVillages getItem(int position) {
    ...
    public View getNoSelectionView() {
        ...
        try {
            TextView dispalyName = (TextView) view.findViewById(R.id.TxtVw_DisplayName);
            dispalyName.setText(mContext.getResources().getString(R.string.select_village));
        }catch (Exception e){}
        return view;
    }
    ...
    public class StringFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<ClusterVillages> filterStrings = new ArrayList<>();
            for (ClusterVillages text : mBackupStrings) {
