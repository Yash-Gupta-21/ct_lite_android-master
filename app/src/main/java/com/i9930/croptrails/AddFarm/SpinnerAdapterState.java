...
public class SpinnerAdapterState extends ArrayAdapter<StateDatum> implements Filterable, ISpinnerSelectedView {

    private Context mContext;
    private ArrayList<StateDatum> mBackupStrings;
    private ArrayList<StateDatum> mStrings;
    private StringFilter mStringFilter = new StringFilter();

    public SpinnerAdapterState(Context context, ArrayList<StateDatum> strings) {
    ...
    public View getNoSelectionView() {
        ...
        try {
            TextView dispalyName = (TextView) view.findViewById(R.id.TxtVw_DisplayName);
            dispalyName.setText(mContext.getResources().getString(R.string.select_state));
        }catch (Exception e){}
        return view;
    }
    ...
    public class StringFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<StateDatum> filterStrings = new ArrayList<>();
            for (StateDatum text : mBackupStrings) {
