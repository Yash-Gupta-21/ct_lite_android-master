...
import filePicker.DividerListItemDecoration;
import filePicker.ToastUtil;
import filePicker.Util;
import filePicker.adapter.AudioPickAdapter;
import filePicker.adapter.FolderListAdapter;
import filePicker.adapter.OnSelectStateListener;
        ...
        if (isNeedRecorder) {
            ...
            rl_rec_aud.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Util.detectIntent(filePicker.activity.AudioPickActivity.this, intent)) {
                        startActivityForResult(intent, Constant.REQUEST_CODE_TAKE_AUDIO);
                    } else {
                        ToastUtil.getInstance(filePicker.activity.AudioPickActivity.this).showToast(getString(R.string.vw_no_audio_app));
                    }
                }
            });
        }
