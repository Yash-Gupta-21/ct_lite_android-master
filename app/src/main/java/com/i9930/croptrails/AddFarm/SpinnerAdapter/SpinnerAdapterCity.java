...
public class SpinnerAdapterCity extends ArrayAdapter<CityDatum> implements Filterable, ISpinnerSelectedView {

    private Context mContext;
    private ArrayList<CityDatum> mBackupStrings;
    private ArrayList<CityDatum> mStrings;
    private StringFilter mStringFilter = new StringFilter();

    public SpinnerAdapterCity(Context context, ArrayList<CityDatum> strings) {
    ...
    public class StringFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<CityDatum> filterStrings = new ArrayList<>();
            for (CityDatum text : mBackupStrings) {
