...
import com.i9930.croptrails.showcaseview.shape.CircleShape;
import com.i9930.croptrails.showcaseview.shape.NoShape;
import com.i9930.croptrails.showcaseview.shape.OvalShape;
import com.i9930.croptrails.showcaseview.shape.RectangleShape;
import com.i9930.croptrails.showcaseview.shape.Shape;
import com.i9930.croptrails.showcaseview.target.Target;
import com.i9930.croptrails.showcaseview.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private LinearLayout showcase_lay;
    ...
    private void init(Context context) {
        ...
        showcase_lay= contentView.findViewById(R.id.showcase_lay);
    ...
    private void setSkipText(CharSequence skipText) {
        if (mSkipButton != null) {
            ...
            Log.e("ShowCaseView"," skipGravity " +mSkipButton.getGravity());
    ...
    public void setSkipTextGravity(int skipTextGravity){
        if(mSkipButton != null ) {
            this.mSkipButton.setGravity(skipTextGravity);
        }
    }
    ...
    public static class Builder {
        ...
        public Builder setDismissTextGravity(int dismissTextGravity){
            showcaseView.setDismissTextGravity(dismissTextGravity);
            return this ;
        }

        public Builder setContentTextGravity(int mGravity){
            showcaseView.setContentTextGravity(mGravity);
            return this ;
        }

        public Builder setTitleTextGravity(int mGravity){
            showcaseView.setTitleTextGravity(mGravity);
            return this ;
        }

        public Builder setSkipTextGravity(int mGravity){
            showcaseView.setSkipTextGravity(mGravity);
            return this ;
        }
