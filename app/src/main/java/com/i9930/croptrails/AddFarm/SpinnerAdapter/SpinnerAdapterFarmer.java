...
public class SpinnerAdapterFarmer extends ArrayAdapter<FarmerSpinnerData> implements Filterable, ISpinnerSelectedView {

    private Context mContext;
    private ArrayList<FarmerSpinnerData> mBackupStrings;
    private ArrayList<FarmerSpinnerData> mStrings;
    private StringFilter mStringFilter = new StringFilter();

    public SpinnerAdapterFarmer(Context context, ArrayList<FarmerSpinnerData> strings) {
    ...
    public View getNoSelectionView() {
        ...
        try {
            TextView dispalyName = (TextView) view.findViewById(R.id.TxtVw_DisplayName);
            dispalyName.setText(mContext.getResources().getString(R.string.select_farmer));
    ...
    public class StringFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<FarmerSpinnerData> filterStrings = new ArrayList<>();
            for (FarmerSpinnerData text : mBackupStrings) {
