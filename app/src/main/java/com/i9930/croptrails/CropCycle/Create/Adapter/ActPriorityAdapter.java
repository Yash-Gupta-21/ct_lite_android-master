...
public class ActPriorityAdapter extends ArrayAdapter<Integer> implements Filterable, ISpinnerSelectedView {

    private Context mContext;
    private List<Integer> mBackupStrings;
    private List<Integer> mStrings;
    private ActPriorityAdapter.StringFilter mStringFilter = new ActPriorityAdapter.StringFilter();

    public ActPriorityAdapter(Context context, List<Integer> strings) {
    ...
    public class StringFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<Integer> filterStrings = new ArrayList<>();
            for (Integer text : mBackupStrings) {
                if (text.toString().toLowerCase().contains(constraint.toString().toLowerCase())) {
