...
public class SvSpinnerAdapter extends ArrayAdapter<SupervisorDatum> implements Filterable, ISpinnerSelectedView {
    ...
    private SvSpinnerAdapter.StringFilter mStringFilter = new SvSpinnerAdapter.StringFilter();

    public SvSpinnerAdapter(Context context, ArrayList<SupervisorDatum> strings) {
    ...
    @Override
    public SupervisorDatum getItem(int position) {
    ...
    public class StringFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<SupervisorDatum> filterStrings = new ArrayList<>();
            for (SupervisorDatum text : mBackupStrings) {
